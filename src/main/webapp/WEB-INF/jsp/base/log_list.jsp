  ...
  <div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-block">
        <button class="btn btn-sm btn-info" type="button" id="export">导出</button>
        <table class="table table-condensed">
          ...
          <c:forEach items="${pageInfo.list}" var="p" varStatus="c">
            <tr>
              ...
              <td class="text-center">${p.operator}</td>
          ...
          <nav>
            <ul class="pagination pagination-sm">
              <li class="${pageInfo.pageNum==1?'disabled':''}">
                <a href="${pageContext.request.contextPath}/log/listPage?currentPage=${pageInfo.pageNum-1}"><i class="ion-chevron-left"></i></a>
              </li>

              <c:forEach items="${pageInfo.navigatepageNums}" var="pn">

              <li class="${pageInfo.pageNum==pn?'active':''}">
                <a href="${pageContext.request.contextPath}/log/listPage?currentPage=${pn}">${pn}</a>
              </li>

              </c:forEach>

              <li class="${pageInfo.pageNum==pageInfo.pages?'disabled':''}">
                <a href="${pageContext.request.contextPath}/log/listPage?currentPage=${pageInfo.pageNum+1}"><i class="ion-chevron-right"></i></a>
              </li>
            </ul>
            共${pageInfo.pages}页
          </nav>
